...
uses
  ...
  DBGridEh, Vcl.CheckLst, Vcl.ComCtrls, Vcl.Menus, Vcl.Forms;
...
uses
  uDataComputer, ufrmExportSettings, ufrmExportVertSlantFileSettings,
  ufrmExportVertFileSettings, ufrmExportSlantFileSettings, ufrmConnectionSettings,
