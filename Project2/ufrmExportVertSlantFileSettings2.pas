unit ufrmExportVertSlantFileSettings2;
...
type
  TfrmExportVertSlantFileSettings = class(TForm)
    chkFile: TCheckBox;
    chkFile2: TCheckBox;
    chkFile3: TCheckBox;
    chkFile4: TCheckBox;
...
var
  frmExportVertSlantFileSettings: TfrmExportVertSlantFileSettings;

implementation

{$R *.dfm}

procedure TfrmExportVertSlantFileSettings.chkSelectAll2Click(Sender: TObject);
begin
  ...
  begin
    ...
    chkFile13.Checked := Checked;
    chkFile14.Checked := Checked;
    chkFile15.Checked := Checked;
  end;
end;

procedure TfrmExportVertSlantFileSettings.chkSelectAllClick(Sender: TObject);
begin
  with TCheckBox(Sender) do
  begin
