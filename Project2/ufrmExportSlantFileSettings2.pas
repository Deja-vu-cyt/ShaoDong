unit ufrmExportSlantFileSettings2;
...
type
  TfrmExportSlantFileSettings = class(TForm)
    chkFile: TCheckBox;
    chkFile2: TCheckBox;
    chkFile3: TCheckBox;
    chkFile4: TCheckBox;
...
var
  frmExportSlantFileSettings: TfrmExportSlantFileSettings;

implementation

{$R *.dfm}

procedure TfrmExportSlantFileSettings.chkSelectAll2Click(Sender: TObject);
begin
...
procedure TfrmExportSlantFileSettings.chkSelectAllClick(Sender: TObject);
begin
  with TCheckBox(Sender) do
  begin
