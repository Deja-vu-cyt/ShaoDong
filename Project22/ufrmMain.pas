...
var
  CompareTypeList: TStringList;
  i, MaxValueCount, MaxValueCount2, MaxValueCount3, ValueCount, ValueCount2: Integer;
  s, CompareType: string;
begin
  //计算
  fdmtCompareType.IndexName := 'CompareType';
...
begin
  ...
  fdmtCompareType.AddIndex('MaxValueCount', 'MaxValueCount;CompareTypeCount;CompareType', '', [], 'MaxValueCount');
