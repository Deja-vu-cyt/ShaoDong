...
type
  TfrmExportSettings8 = class(TForm)
...
var
  frmExportSettings8: TfrmExportSettings8;
...
function TfrmExportSettings8.CheckValueCount(var ValueCount, ValueCount2: Integer): Boolean;
begin
...
function TfrmExportSettings8.CheckValueCount2(var ValueCount, ValueCount2: Integer): Boolean;
begin
...
procedure TfrmExportSettings8.FormCreate(Sender: TObject);
var
  v: Variant;
  i: Integer;
begin
...
procedure TfrmExportSettings8.btnConfirmClick(Sender: TObject);
var
...
begin
  ...
  fKeyValue.SetKeyValue('Settings18', fSerializer.Serialize(fSettings));
  fKeyValue.SetKeyValue('Settings19', fSerializer.Serialize(fSettings2));
