...
type
  TfrmExportSettings6 = class(TForm)
...
var
  frmExportSettings6: TfrmExportSettings6;
...
function TfrmExportSettings6.CheckSameValueCount(var ValueCount, ValueCount2: Integer): Boolean;
begin
...
function TfrmExportSettings6.CheckSubsectionGroupCount(var ValueCount, ValueCount2, ValueCount3, ValueCount4: Integer): Boolean;
begin
...
function TfrmExportSettings6.CheckSubsectionGroupCount2(var ValueCount, ValueCount2, ValueCount3, ValueCount4: Integer): Boolean;
begin
...
function TfrmExportSettings6.CheckSubsectionGroupCount3(var ValueCount, ValueCount2, ValueCount3, ValueCount4: Integer): Boolean;
begin
...
function TfrmExportSettings6.CheckSubsectionGroupCount4(var ValueCount, ValueCount2, ValueCount3, ValueCount4: Integer): Boolean;
begin
...
function TfrmExportSettings6.CheckSubsectionGroupCount5(var ValueCount, ValueCount2, ValueCount3, ValueCount4: Integer): Boolean;
begin
...
function TfrmExportSettings6.CheckSubsectionGroupCount6(var ValueCount, ValueCount2, ValueCount3, ValueCount4: Integer): Boolean;
begin
...
function TfrmExportSettings6.CheckSubsectionGroupCount7(var ValueCount, ValueCount2, ValueCount3, ValueCount4: Integer): Boolean;
begin
...
function TfrmExportSettings6.CheckFirstNumberGroupCount(var ValueCount, ValueCount2, ValueCount3, ValueCount4: Integer): Boolean;
begin
...
function TfrmExportSettings6.CheckFirstNumberGroupCount2(var ValueCount, ValueCount2, ValueCount3, ValueCount4: Integer): Boolean;
begin
...
function TfrmExportSettings6.CheckFirstNumberGroupCount3(var ValueCount, ValueCount2, ValueCount3, ValueCount4: Integer): Boolean;
begin
...
function TfrmExportSettings6.CheckFirstNumberGroupCount4(var ValueCount, ValueCount2, ValueCount3, ValueCount4: Integer): Boolean;
begin
...
function TfrmExportSettings6.CheckFirstNumberGroupCount5(var ValueCount, ValueCount2, ValueCount3, ValueCount4: Integer): Boolean;
begin
...
function TfrmExportSettings6.CheckFirstNumberGroupCount6(var ValueCount, ValueCount2, ValueCount3, ValueCount4: Integer): Boolean;
begin
...
function TfrmExportSettings6.CheckFirstNumberGroupCount7(var ValueCount, ValueCount2, ValueCount3, ValueCount4: Integer): Boolean;
begin
...
procedure TfrmExportSettings6.FormCreate(Sender: TObject);
var
  v: Variant;
begin
...
procedure TfrmExportSettings6.btnConfirmClick(Sender: TObject);
var
...
begin
  ...
  fKeyValue.SetKeyValue('SlantCompareSpacing', fCompareSpacing);
  fKeyValue.SetKeyValue('SlantSameValueCount', fSameValueCount);
  fKeyValue.SetKeyValue('SlantSameValueCount2', fSameValueCount2);
  fKeyValue.SetKeyValue('Settings14', fSerializer.Serialize(fSettings));
  fKeyValue.SetKeyValue('Settings15', fSerializer.Serialize(fSettings2));
