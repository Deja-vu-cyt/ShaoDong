...
function TfrmExportSettings3.CheckSameValueCount(var ValueCount, ValueCount2: Integer): Boolean;
begin
...
function TfrmExportSettings3.CheckFirstNumberGroupCount(var ValueCount, ValueCount2, ValueCount3, ValueCount4: Integer): Boolean;
begin
...
function TfrmExportSettings3.CheckFirstNumberGroupCount2(var ValueCount, ValueCount2, ValueCount3, ValueCount4: Integer): Boolean;
begin
...
function TfrmExportSettings3.CheckFirstNumberGroupCount3(var ValueCount, ValueCount2, ValueCount3, ValueCount4: Integer): Boolean;
begin
...
function TfrmExportSettings3.CheckFirstNumberGroupCount4(var ValueCount, ValueCount2, ValueCount3, ValueCount4: Integer): Boolean;
begin
...
function TfrmExportSettings3.CheckFirstNumberGroupCount5(var ValueCount, ValueCount2, ValueCount3, ValueCount4: Integer): Boolean;
begin
...
function TfrmExportSettings3.CheckFirstNumberGroupCount6(var ValueCount, ValueCount2, ValueCount3, ValueCount4: Integer): Boolean;
begin
...
function TfrmExportSettings3.CheckFirstNumberGroupCount7(var ValueCount, ValueCount2, ValueCount3, ValueCount4: Integer): Boolean;
begin
...
begin
  ...
  fKeyValue.SetKeyValue('GroupCounts3', fSerializer.Serialize(fGroupCounts));
  fKeyValue.SetKeyValue('SlantExportFile', fExportFile);
  fKeyValue.SetKeyValue('SlantExportFile2', fExportFile2);
  fKeyValue.SetKeyValue('SlantExportFile3', fExportFile3);
  fKeyValue.SetKeyValue('SlantExportCodeNameCount', fExportCodeNameCount);
  fKeyValue.SetKeyValue('SlantExportCodeNameCount2', fExportCodeNameCount2);
  fKeyValue.SetKeyValue('SlantExportCodeNameCount3', fExportCodeNameCount3);
